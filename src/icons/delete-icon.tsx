...
//https://material.io/resources/icons/?icon=delete_forever&style=round
const DeleteIcon = () => {
  return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="24px" height="24px">

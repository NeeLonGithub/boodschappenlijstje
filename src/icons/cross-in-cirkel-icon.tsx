...
// https://fonts.google.com/icons?selected=Material%20Icons%20Round%3Ahighlight_off
  const CrossInCirkelIcon = () => {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" width="24px" height="24px" >
...
export default CrossInCirkelIcon;
